...
//    Description: A skiing game for Arduboy ported from Skibuino.
//        Version: 1.0.0
//           Date: 01 Apr 2018
  ...
  while (1)
  {
    if (gb.update())
    {
      ...
      if (highScoreResetFlag)
      {
        ...
        gb.display.println(F(" Up: Cancel"));
      ...
      else // Draw Regular Pause Menu
      {
        ...
        gb.display.println(F("Up: Resume Game"));
